...
type
  ...
  public
    ...
    function GetStatusColor(Status: TGitStatus): TColor;
    procedure Load;
    procedure Save;
...
function TGitColors.GetLogActionColor(ActionChar: Char): TColor;
begin
  if FEnabled then
  begin
    case ActionChar of
...
function TGitColors.GetStatusColor(Status: TGitStatus): TColor;
begin
  if FEnabled then
  begin
    case Status of
