...
function GetCheckoutInformation(const URLHistory: TStringList;
  ...
  var Uncompressed, IgnoreExternals: Boolean; var Revision: string): Boolean;
var
  CheckoutDialog: THgCheckoutDialog;
begin
  CheckoutDialog := THgCheckoutDialog.Create(Application);
...
procedure THgCheckoutDialog.BrowseDestinationClick(Sender: TObject);
var
  Path: string;
begin
...
procedure THgCheckoutDialog.BrowseURLClick(Sender: TObject);
var
  Path: string;
begin
  Path := URL.Text;
...
procedure THgCheckoutDialog.CurrentRevisionClick(Sender: TObject);
begin
  RevisionLabel.Enabled := not CurrentRevision.Checked;
  SelectRevision.Enabled := not CurrentRevision.Checked;
end;

procedure THgCheckoutDialog.DestinationKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  EnableOk;
end;

procedure THgCheckoutDialog.EnableOk;
begin
  Ok.Enabled := (URL.Text <> '') and (Destination.Text <> '');
end;

procedure THgCheckoutDialog.HelpClick(Sender: TObject);
begin
  Application.HelpContext(HelpContext);
end;

procedure THgCheckoutDialog.URLKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  EnableOk;
end;
